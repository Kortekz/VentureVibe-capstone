<template>
  <div class="home">
    <div class="container">
      ...
      <!-- Image on the right -->
      <img src="https://i.ibb.co/RgPQy2R/receptionist-elegant-suit-during-work-hours-with-customer.jpg" alt="Receptionist" class="about-image">
    </div>
  </div>
</template>
...
p {
  color: black; /* Match the navbar text color */
  padding-top: 10px;
  font-size: 18px;
  font-weight: 500;
}
